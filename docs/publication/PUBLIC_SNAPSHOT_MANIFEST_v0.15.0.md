# Public Snapshot Manifest v0.15.0
...
- `CITATION.cff`
- `CHANGELOG.md`
- `docs/publication/RELEASE_NOTES_v0.15.0.md`
- `docs/publication/repository_hygiene_audit_v0.15.0.md`
...
## Rationale
This snapshot is a metadata-only operator prompt governance checkpoint and must remain reproducible, schema-valid, and free of media binaries and secrets.

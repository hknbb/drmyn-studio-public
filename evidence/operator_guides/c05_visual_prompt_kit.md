...
```text
Use the registered C05 Marcus Chen FRONT HERO LOCK as the strict identity anchor.
...
Keep facial geometry, age read, body proportions, hair silhouette, and controlled security expression range locked to the anchor. Keep lighting and lens feel consistent with the anchor.
